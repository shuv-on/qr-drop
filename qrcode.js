...
// License: MIT
// Adapted for GNOME Extension (ESM Export)
...
(function () {
    ...
    function QRCodeModelConstructor(typeNumber, errorCorrectLevel) {
    ...
    QRCodeModelConstructor.prototype = {
        ...
        makeImpl: function (test, maskPattern) {
            ...
            if (this.dataCache == null) this.dataCache = QRCodeModelConstructor.createData(this.typeNumber, this.errorCorrectLevel, this.dataList);
    ...
    QRCodeModelConstructor.createData = function (typeNumber, errorCorrectLevel, dataList) {
        ...
        return QRCodeModelConstructor.createBytes(buffer, rsBlocks);
    };
    QRCodeModelConstructor.createBytes = function (buffer, rsBlocks) {
    ...
    QRCodeModel = QRCodeModelConstructor;
})();
